...
class FitGenApp:
    ...
    def generate_weekly_plan(self):
        ...
        print("    1. Push/Pull/Legs (Classic 6-day)")
        print("    2. Upper/Lower (4-day)")
        print("    3. Full Body (3-day)")
        print("    4. Bro Split (6-day bodybuilding)")
        print("    5. Arnold Split (6-day volume)")
        print("    6. PHUL (Power Hypertrophy)")
        print("    7. Core Focus (Ab emphasis)")
        print("    8. Muscle Group Focus (6-day isolation)")
        
        split_choice = input("  Select (1-8): ").strip()
        splits = {
            '1': 'Push/Pull/Legs',
            '2': 'Upper/Lower',
            '3': 'Full Body',
