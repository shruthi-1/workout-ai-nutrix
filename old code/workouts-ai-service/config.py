...
SPLITS = {
    'Push/Pull/Legs': {
        ...
        'Tuesday': {'name': 'Pull', 'body_parts': ['Back', 'Biceps']},
        'Wednesday': {'name': 'Legs', 'body_parts': ['Quadriceps', 'Hamstrings', 'Glutes']},
        'Thursday': {'name': 'Rest', 'body_parts': []},
        'Friday': {'name': 'Push', 'body_parts': ['Chest', 'Shoulders', 'Triceps']},
        'Saturday': {'name': 'Pull', 'body_parts': ['Back', 'Biceps']},
        'Sunday': {'name': 'Legs', 'body_parts': ['Quadriceps', 'Hamstrings', 'Glutes']}
    },
    'Upper/Lower': {
        'Monday': {'name': 'Upper', 'body_parts': ['Chest', 'Back', 'Shoulders']},
        'Tuesday': {'name': 'Lower', 'body_parts': ['Quadriceps', 'Hamstrings', 'Glutes']},
        'Wednesday': {'name': 'Upper', 'body_parts': ['Chest', 'Back', 'Shoulders']},
        'Thursday': {'name': 'Rest', 'body_parts': []},
        'Friday': {'name': 'Lower', 'body_parts': ['Quadriceps', 'Hamstrings', 'Glutes']},
        'Saturday': {'name': 'Full Body', 'body_parts': ['Chest', 'Back', 'Legs']},
        'Sunday': {'name': 'Rest', 'body_parts': []}
    },
    'Full Body': {
        'Monday': {'name': 'Full Body', 'body_parts': ['Chest', 'Back', 'Legs', 'Shoulders']},
        'Tuesday': {'name': 'Rest', 'body_parts': []},
        'Wednesday': {'name': 'Full Body', 'body_parts': ['Chest', 'Back', 'Legs', 'Shoulders']},
        'Thursday': {'name': 'Rest', 'body_parts': []},
        'Friday': {'name': 'Full Body', 'body_parts': ['Chest', 'Back', 'Legs', 'Shoulders']},
